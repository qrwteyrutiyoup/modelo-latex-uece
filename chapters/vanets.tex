...
móvel ad-hoc (\sigla{MANET}{\textit{Mobile Ad hoc NETwork}}, \textit{Mobile Ad
hoc NETwork}) formada entre veículos (\sigla{V2V}{\textit{Vehicle-to-vechicle}} -
Figura \ref{fig:v2v}) e entre veículos e dispositivos de infraestrutura
(\sigla{V2I}{\textit{Vehicle-to-infrastructure}} - Figura \ref{fig:v2i}). Os
dispositivos instalados nos veículos são conhecidos por \textit{unidades de
bordo} (\sigla{OBU}{\textit{On-board unit}}, \textit{On-board unit}) e os que
ficam ao longo da estrada são denominados por \textit{unidades de acostamento}
(\sigla{RSU}{\textit{Road-side unit}}, \textit{Road-side unit}).
...
(\sigla{ITS}{\textit{Intelligent Transportation System}}, \textit{Intelligent
...
consórcio \sigla{C2C-CC}{\textit{Car-to-Car Communication Consortium}}
(\textit{Car-to-Car Communication Consortium}) e o IEEE está trabalhando na
família de padrões IEEE 1609, voltados à tecnologia
\sigla{WAVE}{\textit{Wireless Access in Vehicular Environments}}
...
transportes inteligentes (\sigla{ITS}{\textit{Intelligent Transportation
...
\sigla{WLANs}{\textit{Wireless Local Area Networks}}
\sigla{IEEE}{\textit{Institute of Electric and Electronic Engineers}}
802.11a/b/g/p e \sigla{WiMAX}{\textit{Worldwide Interoperability for Microwave
